...
This guide walks you through installing asus-merlin-acme-ca on your Asus router running Merlin firmware.
...
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/asus-merlin-acme-ca/main/tools/validate-acme-wrapper.sh \
...
```bash
# Quick diagnostic
curl -fsSL https://raw.githubusercontent.com/YOUR_USERNAME/asus-merlin-acme-ca/main/tools/diagnose-acme-issue.sh | sh
```
